          ...
          child: Stack(
            ...
            children: [
              ...
              if (selectedButtonIndex == 0) ...[
                                ...
                                child: Column(
                                  ...
                                  children: [
                                        ...
                                        SizedBox(
                                          ...
                                          child: Image.asset(
                                            camera.snapshotUrl.isNotEmpty
                                                ? 'assets/images/geye.jpg'
                                                : 'assets/images/reye.jpg',
                                          ),
                                        ),
                                        SizedBox(
                                          width: Width * 0.3,
                                    ...
                                    SizedBox(
                                      height: Height * 0.3,
                                      child: Center(
                                        child: camera.snapshotUrl.isNotEmpty
                                            ? Stack(
                                                alignment: Alignment.center,
                                                children: [
                                                  Image.network(
                ...
                Positioned(
                  top: Height * 0.3, // Adjust the position from the bottom
                  left: 30,
                  child: Column(
                    children: [
                      Container(
